...
//This is a crud application with list.php file
    ...
    if(isset($_POST['update'])){
        $update_id=$_GET['id'];
        if(isset($update_id)){
            $sql = "UPDATE userinfo SET first_name='$_POST[first_name]',last_name='$_POST[last_name]',email='$_POST[email]',password='$_POST[password]',byear='$_POST[byear]',bmonth='$_POST[bmonth]',bday='$_POST[bday]',gender='$_POST[gender]',hobby='$_POST[hobby]',favourite_food='$_POST[favourite_food]',comment='$_POST[comment]',modified=NOW() WHERE id=$update_id";
